...
public class HelloWorldTestCase {
	...
	//Performance Test
	@Test(timeout=35)
	public void aWaitForATime(){
		// Print statement
		System.out.println("@Test Will Be Waiting For 35 Milliseconds :: Supposed Task Should Be Done Before Timeout");
	...
	public void cNullPointerExceptionShouldBeRaised() throws UnsupportedEncodingException{
		// Define variable
